...
- [x] **Step 3: Add the check to the retained entry point**
...
- [x] **Step 2: Add installation and quickstart content**
...
- [x] **Step 3: Add the complete shell reference**
...
- [x] **Step 5: Add operations and troubleshooting**
...
- [x] **Step 6: Run the contract test and confirm the remaining failure**
...
- [x] **Step 1: Implement the documentation layout**
...
- [x] **Step 2: Implement local search**
...
- [x] **Step 3: Implement copy and navigation behavior**
...
- [x] **Step 5: Commit the interactive presentation**
...
- [x] **Step 1: Add and run the failing landing-page assertion**
...
- [x] **Step 2: Update landing-page navigation**
...
- [x] **Step 4: Commit landing-page integration**
...
- [x] **Step 1: Run the retained verification**
...
- [x] **Step 2: Review the final boundary**
